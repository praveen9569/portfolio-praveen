        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-gray-500 text-sm">
              © {currentYear} Portfolio. Check out my <a href="https://codolio.com/profile/praveen12" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-white transition-colors duration-300">Codolio profile</a> for coding challenges.
            </p>
          </div>
        </div>
      </div>
